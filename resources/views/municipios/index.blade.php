...
<form action="{{ route('prueba.update', $prueba)}}" class="container col-md-4" method="POST" enctype="multipart/form-data">
    @method('PUT')
         ...
         @error('title')
          ...
          <div class="mb-3">
            ...
            <div class="">
                <h5>Tiempo</h5>
                <input class="date form-control" type="text" for="tiempo", name="tiempo" autocomplete="off" value="{{$prueba->tiempo}}">
            </div>
